...
Route::group(['middleware' => ['setLanguage']], function () {
    ...
    Route::post('/book-appointment', 'Web\WebController@bookAppointment')->name('book-appointment');
    Route::get('/appointment', 'Web\WebController@appointment')->name('appointment');
    Route::post('/appointment-form', 'Web\WebController@appointmentFromOther')->name('appointment.post');
...
Route::group(['middleware' => ['auth', 'verified', 'xss', 'checkUserStatus']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist|Nurse|Accountant|Lab Technician|Pharmacist|Case Manager']],
        function () {
            Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
                Route::get('notice-board', 'NoticeBoardController@index')->name('employee.noticeboard')->middleware('modules');
    ...
    Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist']], function () {
        ...
        Route::group(['prefix' => 'patient', 'namespace' => 'Patient'], function () {
            ...
            Route::get('my-prescriptions/{id}', 'PrescriptionController@show')->name('prescription.show');
        });
    });
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|Accountant']], function () {
        Route::get('doctors/{doctor}', 'DoctorController@show')->where('doctor', '[0-9]+')->name('doctors_show');
    });
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist|Patient']], function () {
        ...
        Route::get('doctor-schedule-list', 'ScheduleController@doctorScheduleList')->name('admin-doctor-schedule-list');
    });
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Lab Technician|Pharmacist|Case Manager|Accountant|Receptionist']],
        function () {
            Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
    ...
    Route::group(['middleware' => ['role:Pharmacist']],
        function () {
            Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
                ...
                Route::get('export-prescription',
                    'PrescriptionController@prescriptionExport')->name('employee.prescriptions.excel');
            });
        });
    ...
    Route::group(['middleware' => ['role:Admin|Patient']], function () {
        Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
            ...
            Route::get('invoices/{invoice}/pdf', 'InvoiceController@convertToPdf')
                ->where('invoice', '[0-9]+');
            Route::get('bills', 'BillController@index')->name('employee.bills.index')->middleware('modules');
    ...
    Route::group(['middleware' => ['role:Admin|Doctor']], function () {
        ...
        Route::get('prescriptions/{id}/view', 'PrescriptionController@prescriptionsView');
        Route::get('prescription-pdf/{id}', 'PrescriptionController@convertToPDF')->name('prescriptions.pdf');
        Route::post('prescription-medicine', 'PrescriptionController@prescreptionMedicineStore')->name('prescription.medicine.store');
        Route::get('prescriptions-show-modal/{id}',
            'PrescriptionController@showModal')->name('prescriptions.show.modal');
        ...
        Route::post('vaccinations/{vaccination}/update', 'VaccinationController@update')->name('vaccination.update');
    ...
    Route::group(['middleware' => ['role:Admin|Accountant|Doctor|Nurse|Receptionist|Lab Technician|Pharmacist|Case Manager']],
        function () {
            ...
            Route::get('employee-payrolls-show/{employeePayroll}',
                'EmployeePayrollController@showModal')->where('employeePayroll',
    ...
    Route::group(['middleware' => ['role:Admin|Nurse|Receptionist|Doctor|Case Manager']], function () {
        Route::get('patient-cases/{patient_case}', 'PatientCaseController@show')->where('patient_case',
            '[0-9]+')->name("patient_case_show");
        Route::get('patient-cases-show-modal/{patient_case}', 'PatientCaseController@showModal')->where('patient_case',
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist|Lab Technician|Pharmacist']], function () {
        ...
        Route::get('radiology-tests-show-modal/{radiologyTest}',
            'RadiologyTestController@showModal')->name('radiology.test.show.modal');
        ...
        Route::get('pathology-tests-show-modal/{pathologyTest}',
            'PathologyTestController@showModal')->name('pathology.test.show.modal');
...
//        Route::post('departments/{department}/active-deactive', 'DepartmentController@activeDeactiveDepartment');
        ...
        Route::post('admins/{accountant}/active-deactive', 'adminController@activeDeactiveStatus');
        ...
        Route::resource('currency-settings', 'CurrencySettingController');
    ...
    Route::group(['middleware' => ['role:Admin|Patient']], function () {
        Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
            ...
            Route::get('patient-diagnosis-test/{patientDiagnosisTest}/pdf',
                'PatientDiagnosisTestController@convertToPdf')->name('employee.patient.diagnosis.test.pdf');
        });
    });
...
Route::get('/set-language', 'Web\WebController@setLanguage')->name('set-language');
