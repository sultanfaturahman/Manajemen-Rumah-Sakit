...
class PatientCase extends Model
{
    ...
    public function preparePatientCase(): array
    {
        return [
            ...
            'status'       => self::STATUS_ARR[$this->status],
            'case_date'    => isset($this->date) ? Carbon::parse($this->date)->format('d F Y') : '',
            'case_time'    => isset($this->date) ? Carbon::parse($this->date)->format('h:i A') : '',
            'fee'          => $this->fee,
