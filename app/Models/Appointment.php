...
class Appointment extends Model
{
    ...
    function prepareAppointment()
    {
        return [
            ...
            'appointment_date'  => isset($this->opd_date) ? Carbon::parse($this->opd_date)->format('d F y') : '',
            'appointment_time'  => isset($this->opd_date) ? \Carbon\Carbon::parse($this->opd_date)->isoFormat('LT') : '',
